...
def generate_ai_resume():
    ...
    try:
        ...
        prompt = f"""
        You are an expert resume writer. Rewrite and professionally enhance the following resume data.
        Format it inside HTML with the following guidelines:
        - Wrap all content inside <div class="content-wrapper">...</div>
        - Use clear section headings in ALL CAPS (e.g., PROFESSIONAL SUMMARY, EDUCATION)
        - Use bullet points where needed
        - Skip any section that is empty or 'Not Provided'
        - Don't add commentary or labels like "RAW:"
        Resume Data:
        ---
        {user_input_text}
        ---
        ...
        # Optional: basic HTML safety
        if "<div" not in html_content:
            raise Exception("No HTML generated by AI.")
